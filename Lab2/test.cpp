...
int main(){
   ...
   w.addWord("one");
	w.addWord("one"); // adding duplicate
	w.addWord("two");
	w.addWord("three");  // I modified a little to test sorting 
	w.addWord("three");
	w.addWord("four");
	w.addWord("four");
	w.addWord("four");
	w.addWord("four");
	w.addWord("five");
	w.addWord("five"); // adding duplicate
	w.addWord("six");
	w.addWord("Six");  // I modified a little to test sorting
	w.addWord("seven");
	w.addWord("seven");
	w.addWord("eight");
	w.addWord("Seven");
	w.addWord("eight");
	w.addWord("Ten");
	w.addWord("Ten"); // adding duplicate
	w.addWord("nine");
	w.addWord("Nine");  // I modified a little to test sorting
	w.addWord("ten");
	w.addWord("Nine");
	w.addWord("Four");
	w.addWord("One");
